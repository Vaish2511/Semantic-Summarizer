...
**4. Application Details**
    ...
    4. Visualizations
        The application provides the following visualizations for a detailed comparison:
            Heatmap: A color-coded matrix showing the similarity score between the two summaries.
            Radar Chart: A plot displaying three metrics: similarity, dissimilarity, and overlap.
